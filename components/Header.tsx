...
const Header: React.FC<HeaderProps> = ({ onProfileClick, onAssistantClick }) => {
  return (
      ...
      <div className="max-w-screen-2xl mx-auto px-4 lg:px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors px-3 py-2 rounded-lg shadow-sm"
